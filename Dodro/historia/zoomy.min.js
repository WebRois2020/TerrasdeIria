...
f===void 0?(f=j,j="click"):j===void 0&&(j="click");f=e.extend({zoomSize:200,round:false,glare:true,clickable:false,attr:"href",border:"5px solid #999",zoomInit:null,zoomStart:null,zoomStop:null},f);e(this).each(function(){var a=e(this),b=a.find("img");m.init(a,b)})}})(jQuery);